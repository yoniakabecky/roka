...
<CalendarPrimitive.Day
	...
	class={cn(
		...
		'[&[data-today]:not([data-selected])]:ring-1 [&[data-today]:not([data-selected])]:ring-primary [&[data-today]:not([data-selected])]:ring-inset [&[data-today][data-disabled]]:text-muted-foreground',
